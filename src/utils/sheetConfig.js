...
const FIELD_PATTERNS = {
  ...
  mes: /^(mes|month|fecha_mes)$/,
  fecha: /^(fecha|date|dia|day|fecha_dia)$/,
  ...
  inversion: /^(inversion|investment|spend|costo|inversion_real)$/,
  presupuesto: /^(presupuesto|budget|presupuesto_asignado|budget_asignado|inversion_meta|presupuesto_meta)$/,
  ...
  cvr: /^(cvr|view_rate|vtr|completion_rate)$/,
  ...
  objetivo: /^(objetivo|objective|goal|tipo_de_compra|tipodecompra)$/,
  objetivo_detectado: /^(objetivo_detectado|detected_objective)$/,
  meta: /^(meta|target|goal_value|meta_value)$/,
  resultado: /^(resultado|result|performance|resultado_actual|resultados)$/,
  ...
  crecimiento_pct: /^(crecimiento_pct|crecimiento|growth|growth_pct|growth_percent)$/ ,
  ...
  // Projecciones
  metrica: /^(metrica|metric|medida|tipo_compra|tipodecompra)$/,
  proyeccion: /^(proyeccion|projection|forecast|resultado_meta|resultados|resultados_meta|meta_proyeccion)$/,
  real: /^(real|actual|resultado_real)$/,
  cpr_meta: /^(cpr|cpr_meta|cprmeta|cost_per_result)$/,
  tipo_proyeccion: /^(tipo_proyeccion|tipoproyeccion|projection_type|tipo_de_proyeccion)$/,
  tipo_campana: /^(tipo_campana|tipocampana|tipo_de_campana|campaign_type|audiencia)$/,
  fecha_inicio: /^(fecha_inicio|fechainicio|inicio|fecha_desde|start_date|periodo_inicio)$/,
  fecha_fin: /^(fecha_fin|fechafin|fin|fecha_hasta|end_date|periodo_fin)$/,
}
